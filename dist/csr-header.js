...
var _FccSymbol = _interopRequireDefault(require("./assets/FccSymbol.svg"));
var _FccSymbolError = _interopRequireDefault(require("./assets/FccSymbolError.svg"));
...
function ComponentCsrHeaderComponent(props) {
  ...
  }, /*#__PURE__*/_react.default.createElement("ul", null, quickLinks.map(ql => /*#__PURE__*/_react.default.createElement("li", null, /*#__PURE__*/_react.default.createElement(_reactRouterDom.Link, {
    to: ql.link,
    onClick: () => setExpanded(!expanded)
